...
export class UserController {
    ...
    @Post()
    async postUser(@Body() userRequestDto: UserRequestDto): Promise<UserResponseDto> {
    ...
    @Put(':userId')
    async updateUser(@Param('userId') userId: string, @Body() userRequestDto: UserRequestDto): Promise<UserResponseDto> {
